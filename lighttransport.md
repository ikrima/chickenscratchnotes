...
* [TLDR](#tldr)
	...
	* [Useful if completely new to rendering/photon mapping:](#useful-if-completely-new-to-renderingphoton-mapping)
...
![](resources/emradiation.png)
  ...
  - General scattering mechanism which gives diffuse reflection by a solid surface
	...
	Reference https://www.physicsforums.com/insights/do-photons-move-slower-in-a-solid-medium/
